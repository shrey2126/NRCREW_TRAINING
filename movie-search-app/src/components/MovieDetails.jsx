...
const MovieDetails = ({ movieId, onClose, onBackToHome, isFavorite, toggleFavorite }) => {
        ...
        <div className="relative">
          <div className="absolute top-4 right-4 z-10 flex gap-2">
            <button
              ...
              className="p-2 bg-black/50 hover:bg-black/70 rounded-full transition-all duration-300 hover:scale-110 active:scale-95"
              title="Back to Home"
            >
